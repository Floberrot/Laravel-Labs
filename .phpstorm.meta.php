...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/floberrot/PhpStormProjects/laravel-lab/public/storage',
...
'sanctum.csrf-cookie','health','hello-name','hello.opt',
'users.show','v1.status','v1.version','v1.','tests.index','tests.show',
'articles.index','articles.show','files.link','files.download','session.get',
'api.v2.','posts.store','posts.index','posts.show.id','logs.get',
'logs.raw','logs.','logs.paginated','logs.paginated.search','logs.paginated.simple',
'logs.show.id','books.index','books.store',
'books.show','books.update','books.destroy','books.comments.index','books.comments.store',
'comments.show','comments.update','comments.destroy','books.book-details.index','books.book-details.store',
'book-details.show','book-details.update','book-details.destroy','tags.index','tags.store',
'tags.show','tags.update','tags.destroy',
'example.show','storage.local',);
        registerArgumentsSet('views', 
'example','example.show','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
