...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Services\PaymentGatewayInterface' => \App\Services\StripeGateway::class,
    ...
    override(\config(), map([
            ...
            'filesystems.disks.b2.driver' => 'string',
            'filesystems.disks.b2.key' => 'string',
            'filesystems.disks.b2.secret' => 'string',
            'filesystems.disks.b2.region' => 'string',
            'filesystems.disks.b2.bucket' => 'string',
            'filesystems.disks.b2.endpoint' => 'string',
            'filesystems.disks.b2.url' => 'NULL',
            'filesystems.disks.b2.use_path_style_endpoint' => 'boolean',
            'filesystems.links./Users/floberrot/PhpStormProjects/laravel-lab/public/storage' => 'string',
            'horizon.domain' => 'NULL',
            'horizon.path' => 'string',
            'horizon.use' => 'string',
            ...
            'horizon.defaults.supervisor-2.connection' => 'string',
            'horizon.defaults.supervisor-2.queue' => 'array',
            'horizon.defaults.supervisor-2.balance' => 'string',
            'horizon.defaults.supervisor-2.autoScalingStrategy' => 'string',
            'horizon.defaults.supervisor-2.maxProcesses' => 'integer',
            'horizon.defaults.supervisor-2.tries' => 'integer',
            'horizon.defaults.supervisor-2.backoff' => 'array',
            'horizon.defaults.supervisor-2.maxTime' => 'integer',
            'horizon.defaults.supervisor-2.maxJobs' => 'integer',
            'horizon.defaults.supervisor-2.memory' => 'integer',
            'horizon.defaults.supervisor-2.timeout' => 'integer',
            'horizon.defaults.supervisor-2.nice' => 'integer',
            ...
            'queue.connections.rabbitmq.options' => 'array',
...
'filesystems.disks.s3.report','filesystems.disks.b2.driver','filesystems.disks.b2.key','filesystems.disks.b2.secret','filesystems.disks.b2.region',
'filesystems.disks.b2.bucket','filesystems.disks.b2.endpoint','filesystems.disks.b2.url','filesystems.disks.b2.use_path_style_endpoint','filesystems.links./Users/floberrot/PhpStormProjects/laravel-lab/public/storage',
...
'horizon.defaults.supervisor-1.autoScalingStrategy','horizon.defaults.supervisor-1.maxProcesses','horizon.defaults.supervisor-1.tries','horizon.defaults.supervisor-1.maxTime','horizon.defaults.supervisor-1.maxJobs',
'horizon.defaults.supervisor-1.memory','horizon.defaults.supervisor-1.timeout','horizon.defaults.supervisor-1.nice','horizon.defaults.supervisor-2.connection','horizon.defaults.supervisor-2.queue',
'horizon.defaults.supervisor-2.balance','horizon.defaults.supervisor-2.autoScalingStrategy','horizon.defaults.supervisor-2.maxProcesses','horizon.defaults.supervisor-2.tries','horizon.defaults.supervisor-2.backoff',
'horizon.defaults.supervisor-2.maxTime','horizon.defaults.supervisor-2.maxJobs','horizon.defaults.supervisor-2.memory','horizon.defaults.supervisor-2.timeout','horizon.defaults.supervisor-2.nice',
...
'queue.connections.redis.queue','queue.connections.redis.retry_after','queue.connections.redis.block_for','queue.connections.redis.after_commit','queue.connections.rabbitmq.driver',
'queue.connections.rabbitmq.queue','queue.connections.rabbitmq.connection','queue.connections.rabbitmq.hosts.0.host','queue.connections.rabbitmq.hosts.0.port','queue.connections.rabbitmq.hosts.0.user',
'queue.connections.rabbitmq.hosts.0.password','queue.connections.rabbitmq.hosts.0.vhost','queue.connections.rabbitmq.options','queue.connections.rabbitmq.worker','queue.batching.database',
...
'signed','throttle','verified','measure',);
...
'horizon.jobs.show','horizon.index','sanctum.csrf-cookie','health',
'hello-name','hello.opt','users.show','v1.status','v1.version',
'v1.','tests.index',
'tests.show','articles.index','articles.show',
'files.link','files.download','session.get','api.v2.','posts.store','posts.index',
'posts.show.id','logs.get','logs.raw','logs.','logs.paginated',
'logs.paginated.search','logs.paginated.simple','logs.show.id',
'books.index','books.store','books.show','books.update','books.destroy',
'books.comments.index','books.comments.store','comments.show','comments.update','comments.destroy',
'books.book-details.index','books.book-details.store','book-details.show','book-details.update','book-details.destroy',
'tags.index','tags.store','tags.show','tags.update','tags.destroy',
'example.show','storage.local',);
        registerArgumentsSet('views', 
'example','example.show','mails.book-created','welcome','horizon::layout',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','B3_KEY',
'B3_SECRET','B3_BUCKET','B3_ENDPOINT','B3_REGION',);
